...
public final class set_005forg_005fdetails_jsp extends org.apache.jasper.runtime.HttpJspBase
...
ResultSet rs=st.executeQuery("select * from orgdetails");
      ...
      out.write("<div id=\"emp-right-content\">Enter Organisation details \r\n");
 while(rs.next())
	{
	
      out.write("<form action=\"http://localhost:8080/TGMC/Setorg\" method=\"get\" >\r\n");
      out.write("<textarea cols=\"70\" rows=\"20\" name=\"orgdetails\" >");
      out.print(rs.getString(1));
      out.write(" </textarea><br />\r\n");
      out.write("<input type=\"submit\" value=\"update\" id=\"submit\" />\r\n");
      out.write("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type=\"button\" value=\"cancel\"\r\n");
      out.write("\tid=\"submit\" onsubmit=\"http://localhost:8080/TGMC/org_details_op.jsp\" />\r\n");
      out.write("\t</form>\r\n");
      out.write("\t");
}
}
