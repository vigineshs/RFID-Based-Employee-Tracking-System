...
public final class hierarchy_jsp extends org.apache.jasper.runtime.HttpJspBase
...
ResultSet rs=st.executeQuery("select * from hierarchy");
      ...
      out.write("<div id=\"emp-right-content\">hierarchy details  <br />\r\n");
 while(rs.next())
	{
	
      out.write("\r\n");
      out.write("\t<table style=\"font-size:20px;\" cellpadding=\"5\" border =\"1\">\r\n");
