...
public final class set_005fhierarchy_jsp extends org.apache.jasper.runtime.HttpJspBase
...
ResultSet rs=st.executeQuery("select * from hierarchy");
      ...
      out.write("<div id=\"emp-right-content\">Enter hierarchy details \r\n");
 while(rs.next())
	{
	
      out.write("<form action=\"http://localhost:8080/TGMC/Sethierarchy\" method=\"get\" >\r\n");
      out.write("\t<table>\r\n");
      out.write("\t<tr> <td> level 1 </td><td> <input type=\"text\" size=\"20\" name=\"post1\" value=\"");
      out.print(rs.getString(1));
      out.write("\" /></td></tr>\r\n");
      out.write("\t<tr> <td> level 2 </td><td> <input type=\"text\" size=\"20\" name=\"post2\" value=\"");
      out.print(rs.getString(2));
      out.write("\" /></td>\r\n");
      out.write("\t<td> <input type=\"text\" size=\"25\" name=\"post3\" value=\"");
      out.print(rs.getString(3));
      out.write("\" /></td></tr>\r\n");
      out.write("\t<tr> <td> level 3 </td>\r\n");
      out.write("\t<td colspan=\"5\"> <input type=\"text\" size=\"25\" name=\"post4\" value=");
      out.print(rs.getString(4));
      out.write(" /></td></tr>\r\n");
      out.write("\t<tr><td> level 4 </td> <td> <input type=\"text\" size=\"25\" name=\"post5\" value=\"");
      out.print(rs.getString(5));
      out.write("\" /></td>\r\n");
      out.write("\t<td> <input type=\"text\" size=\"25\" name=\"post6\" value=\"");
      out.print(rs.getString(6));
      out.write("\" /></td>\r\n");
      out.write("\t<td> <input type=\"text\" size=\"25\" name=\"post7\" value=\"");
      out.print(rs.getString(7));
      out.write("\" /></td>\r\n");
      out.write("\t<td> <input type=\"text\" size=\"25\" name=\"post8\" value=\"");
      out.print(rs.getString(8));
      out.write("\" /></td>\r\n");
      out.write("\t<td> <input type=\"text\" size=\"25\" name=\"post9\" value=\"");
      out.print(rs.getString(9));
      out.write("\" /></td>\r\n");
      out.write("\t<td> <input type=\"text\" size=\"25\" name=\"post10\" value=\"");
      out.print(rs.getString(10));
      out.write("\" /></td> </tr>\r\n");
      out.write("\t<tr><td>\r\n");
      out.write("<input type=\"submit\" value=\"update\" id=\"submit\" /><td>\r\n");
      out.write("<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type=\"submit\" value=\"cancel\" id=\"submit\"  onsubmit=\"http://localhost:8080/TGMC/hierarchy_op.jsp\" /></td></tr>\r\n");
      out.write("\t</table>\r\n");
      out.write("\t</form>\r\n");
      out.write("\t");
}
