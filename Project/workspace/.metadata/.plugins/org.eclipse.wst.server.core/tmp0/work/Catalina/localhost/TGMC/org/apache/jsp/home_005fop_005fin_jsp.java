...
public final class home_005fop_005fin_jsp extends org.apache.jasper.runtime.HttpJspBase
...
ResultSet rs=st.executeQuery("select * from Details where username='"+ username +"'");
      ...
      out.write("\t<li><a href=\"rfid_in_op.jsp\"> Get in</a></li>\r\n");
      out.write("\t<li><a href=\"#\"> Account Details</a></li>\r\n");
      out.write("\t<li><a href=\"http://localhost:8080/TGMC/Logout\"> Log out</a></li>\r\n");
      out.write("</ul>\r\n");
      out.write("</div>\r\n");
      out.write("</div>\r\n");
