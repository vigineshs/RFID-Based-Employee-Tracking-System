...
public final class account_005fdetails_005fop_jsp extends org.apache.jasper.runtime.HttpJspBase
...
ResultSet rs=st.executeQuery("select * from Tag where username='"+ username +"'");
      ...
      out.write("<form action=\"http://localhost:8080/TGMC/home_op_out.jsp\" method=\"get\"\r\n");
