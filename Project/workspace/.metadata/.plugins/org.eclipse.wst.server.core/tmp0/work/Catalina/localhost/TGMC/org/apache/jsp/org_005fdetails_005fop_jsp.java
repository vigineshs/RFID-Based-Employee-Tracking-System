...
public final class org_005fdetails_005fop_jsp extends org.apache.jasper.runtime.HttpJspBase
...
ResultSet rs=st.executeQuery("select * from orgdetails");
      ...
      out.write("<div id=\"emp-right-content\">About Organisation <a\r\n");
      out.write("\tstyle=\"margin-top: 20px; margin-left: 620px; font-size: 16px;\"\r\n");
      out.write("\thref=\"set_org_details.jsp\">edit</a> <br />\r\n");
      out.write("\t");
 while(rs.next())
	{
