...
ResultSet rs=st.executeQuery("select * from Tag where username='"+ username +"'");
      ...
      out.write("<form action=\"http://localhost:8080/TGMC/home_emp_out.jsp\" method=\"get\"\r\n");
 ...
 while(rs.next())
	{
      ...
      out.write("\t</tr>\r\n");
      out.write("\r\n");
      out.write("You have worked for ");
      out.print(rs.getString("nohr"));
      out.write(" hours and ");
      out.print(rs.getString("nomin"));
      out.write(" minutes\r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("\t\r\n");
      out.write("\t\r\n");
      out.write("\t<tr><td colspan=\"4\"><center><input type=\"submit\" value=\"OK\" style=\"background-color: #5C92E9; color: #fff;\" /></center></td></tr>\r\n");
      out.write("\r\n");
      out.write("</table>\r\n");
}}
