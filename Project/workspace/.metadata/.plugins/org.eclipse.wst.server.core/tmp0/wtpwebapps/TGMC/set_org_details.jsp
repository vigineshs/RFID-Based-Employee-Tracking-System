...
<div id="emp-right-content">Enter Organisation details 
<% while(rs.next())
	{
	%><form action="http://localhost:8090/TGMC/Setorg" method="get" >
<textarea cols="70" rows="20" name="orgdetails" ><%=rs.getString(1)%> </textarea><br />
<input type="submit" value="update" id="submit" />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="button" value="cancel"
	id="submit" onsubmit="http://localhost:8090/TGMC/org_details_op.jsp" />
	</form>
	<%}
}
