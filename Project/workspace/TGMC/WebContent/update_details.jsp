...
<form action="http://localhost:8090/TGMC/Update" method="get"
	onSubmit="validate()">
<% while(rs.next())
	{
	%>
<table>
	...
	<tr><td colspan="4"><center><input type="submit" value="update" style="background-color: #5C92E9; color: #fff;" /></center></td></tr>
