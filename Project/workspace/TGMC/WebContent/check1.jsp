...
<form action="http://localhost:8090/TGMC/ForgotPass" method="post"
	onSubmit="validate()">
<p style="font-size: 24px;">
Enter Employee ID &nbsp;<input type="text" size="20" name="empid" /> <br />
<br />
<input type="submit" value="Check 2" style="background-color: #5C92E9; color: #fff;" /></p>
<br />
</form>
