...
<form action="http://localhost:8090/TGMC/home_emp_out.jsp" method="get"
...
You have worked for <%=rs.getString("nohr")%> hours and <%=rs.getString("nomin")%> minutes


	
	
	<tr><td colspan="4"><center><input type="submit" value="OK" style="background-color: #5C92E9; color: #fff;" /></center></td></tr>
